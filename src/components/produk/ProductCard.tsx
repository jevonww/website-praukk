...
export default function ProductCard({
  ...
  // Fix: Ensure imageUrl is handled properly whether it's full URL or relative path
  const displayImage = imageUrl?.startsWith("http") ? imageUrl : imageUrl ? imageUrl : null;
